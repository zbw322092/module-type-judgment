module.exports = class moduleType {
  ...
  isExports = (node: any): boolean => {
    ...
    function isModuleExportsAttach(): boolean {
      if (
        !nodeLeft.object ||
        !nodeLeft.property ||
    ...
    // eg. module.exports
    function isModuleExportsAssign(): boolean {
    ...
    // eg. exports = {}
    function isExportsAssign(): boolean {
      return isExportsIdentifier(nodeLeft);
    }

    // eg. exports.foo
    function isExportsAttach(): boolean {
